...
public class SelectTestFile {
    ...
    static public JPanel getPanel(CardLayout cl, JFrame mainFrame, Menu menu) {
        ...
        JLabel titleLabel = new JLabel("Selecione um Arquivo de Teste");
        ...
        backButton.addActionListener(e -> cl.show(mainFrame.getContentPane(), "TrainFile"));
